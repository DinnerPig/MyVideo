...
<body id="loginBody" background="images/back3.jpg">
	...
	<div id="loginBezel">
		...
		<div id="loginChildTop">
			<img src="images/logo-right.png" width="57" height="50"
				align="absbottom" /> 视频管理系统
		</div>
		<div id="loginChildBottom">
			<form method="post" action="admin_login.action" id="myLogin">
				<table cellpadding="0" cellspacing="0" width="100%" height="95%"
					border="0">
					<tr>
						<td align="right" width="35%">账 号：</td>
						<td align="left" width="65%"><input id="email"
							class="inputUP" name="username" /> <a id="lab1"
