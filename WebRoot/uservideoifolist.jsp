							...
							<s:iterator var="v" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/userupload_getUseruploadVideoinfo.action?uld=<s:property value="#v.uld"/>">
											<img src="${pageContext.request.contextPath}/img/i_edit.gif"
											border="0" style="CURSOR: hand">
									</a></td>

									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/userupload_deletevideo.action?uld=<s:property value="#v.uld"/>">
				...
				<tr align="center">
					<td colspan="7">第<s:property value="pageBean.page" />/<s:property
							...
							<a
								...
								<a
								href="${ pageContext.request.contextPath }/userupload_getUserVideoInfo.action?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if> <s:if test="pageBean.page != pageBean.totalPage">
							<a
								href="${ pageContext.request.contextPath }/userupload_getUserVideoInfo.action?page=<s:property value="pageBean.page+1"/>">下一页</a>|
								<a
								href="${ pageContext.request.contextPath }/userupload_getUserVideoInfo.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
					</td>
				</tr>
			</TBODY>
