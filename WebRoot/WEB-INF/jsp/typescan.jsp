	...
	<div class="main">
		...
		<div class="info" style="background-color:#CCC; height:40px;">
			<div style="float:left; margin-left:5%; margin-top:9px;">
				搜索"${requestScope.maxtypename}" 类型共找到约
				<s:property value="maxtypescanBean.totalCount" />
				个视频
			</div>
		</div>
			...
			<div style="float:left; width:65%;height:650px;">
				<div>
					...
					<table width="80%" border="0"
						...
						<s:if test="maxtypescanBean.totalCount == 0 ">
						...
						<s:else>
							...
							<s:iterator var="sb" value="maxtypescanBean.list">
								<tr>
		...
		<s:if test="maxtypescanBean.totalCount !=0 ">
			...
			<div style="float:left; margin-left:250px; margin-top:12px;">
				<s:if test="maxtypescanBean.page != 1">
					<a
						href="${ pageContext.request.contextPath }/videoinfo_findbymaxtype.action?maxtype.maxId=${requestScope.maxtypemaxid}&page=1"
						style="text-decoration:none">首页</a>&nbsp;&nbsp;
				<a
						href="${ pageContext.request.contextPath }/videoinfo_findbymaxtype.action?maxtype.maxId=${requestScope.maxtypemaxid}&page=<s:property value="maxtypescanBean.page-1"/>"
						style="text-decoration:none">上一页</a>&nbsp;&nbsp;
				</s:if>
				共
				<s:property value="maxtypescanBean.totalPage" />
				页 /当前第
				<s:property value="maxtypescanBean.page" />
				页&nbsp;&nbsp;
				<s:if test="maxtypescanBean.page !=  maxtypescanBean.totalPage">
					<a
						href="${ pageContext.request.contextPath }/videoinfo_findbymaxtype.action?maxtype.maxId=${requestScope.maxtypemaxid}&page=<s:property value="maxtypescanBean.page+1"/>"
						style="text-decoration:none">下一页</a>&nbsp;&nbsp;
				<a
						href="${ pageContext.request.contextPath }/videoinfo_findbymaxtype.action?maxtype.maxId=${requestScope.maxtypemaxid}&page=<s:property value="maxtypescanBean.totalPage"/>"
